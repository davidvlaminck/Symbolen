...
from symbol_pdf import compute_grid, cell_xy, draw_header
...
for img_name in images:
    ...
    from symbol_pdf import clean_symbol, fit_image_in_circle, mm_to_px
    img = clean_symbol(img)
    diameter_px = mm_to_px(DIAMETER_MM)
